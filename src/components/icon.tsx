...
const WorkspaceSvg = () => (
    <svg fill="currentColor" width="1em" height="1em" viewBox="0 0 50 50">
        <g id="SVGRepo_iconCarrier">
...
const WorkspaceIcon = (props: Partial<CustomIconComponentProps>) => (
    <Icon component={WorkspaceSvg} {...props} />
);

export { OrganizationIcon, WorkspaceIcon };
